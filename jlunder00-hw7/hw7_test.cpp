...
TEST(SortCasesTest, QuickSortDescAndSorted)
{
  LinkedListCollection<string,int> c;
  c.add("a", 10);
  c.add("b", 50);
...
TEST(SortCasesTest, MergeSortDescAndSorted)
{
  LinkedListCollection<string,int> c;
  c.add("a", 10);
  c.add("b", 50);
...
TEST(SortCasesTest, QuickSortZero)
{
  LinkedListCollection<string,int> c;
  c.quick_sort();
  vector<string> sorted_ks;  
...
TEST(SortCasesTest, MergeSortZero)
{
  LinkedListCollection<string,int> c;
  c.merge_sort();
  vector<string> sorted_ks;  
